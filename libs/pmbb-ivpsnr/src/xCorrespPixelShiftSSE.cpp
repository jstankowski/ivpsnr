...
int32V4 xCorrespPixelShiftSSE::CalcDistAsymmetricRow(const xPicI* Ref, const xPicI* Tst, const int32 y, const int32V4& GlobalColorShift, const int32 SearchRange, const int32V4& CmpWeights)
{
  ...
  for (int32 x = 0; x < Width; x++)
  {
    ...
    __m128i BestDist = xCalcDistWithinBlock(Ref, TstV, x, y, SearchRange, CmpWeightsV);
...
__m128i xCorrespPixelShiftSSE::xCalcDistWithinBlock(const xPicI* Ref, const __m128i& TstPelV, const int32 CenterX, const int32 CenterY, const int32 SearchRange, const __m128i& CmpWeightsV)
{
