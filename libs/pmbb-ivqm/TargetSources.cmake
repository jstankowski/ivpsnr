...
set(SRCLIST_PUBLIC  ${SRCLIST_COMMON_H} ${SRCLIST_MTC_H} ${SRCLIST_WS_H} ${SRCLIST_GCD_H} ${SRCLIST_CPS_H} ${SRCLIST_IVPSNR_H})
set(SRCLIST_PRIVATE                     ${SRCLIST_MTC_C} ${SRCLIST_WS_C} ${SRCLIST_GCD_C} ${SRCLIST_CPS_C} ${SRCLIST_IVPSNR_C})
